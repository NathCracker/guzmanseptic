...
<div className='flex flex-col bg-slate-800'>
  <div className='flex justify-around items-center bg-slate-800 min-w-full w-full pt-16 pb-3 max-sm:flex-col max-sm:w-full'>
    <div className='flex flex-col justify-center gap-5 items-center w-2/6'>
      ...
      <button className='max-sm:text-xs max-sm:py-2 appearance-none block py-1.5 rounded-sm w-1/2 text-white bg-slate-900 transition-all hover:border border-slate-900 hover:bg-transparent duration-100 max-sm:w-1/2' type="submit">Sign up</button>
      </div>
    </div>
