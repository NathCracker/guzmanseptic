...
const services = () => {
  ...
  return (
    <div className='bg-gray-200 text-center w-full max-h-full flex flex-col items-center' id='services'>
        <h1 className='text-5xl pt-10' ref={h1Text}>SERVICES WE OFFER</h1>
        <div ref={cardAnim} className='flex justify-around items-center py-10 max-sm:flex-wrap max-sm:gap-5 max-md:flex-wrap lg:flex-wrap max-lg:flex-wrap w-8/12'>
